                        ...
                        <table class="table table-bordered table-hover" style="background-color:#fff">
                            <thead>
                                <tr>
                                    ...
                                    <td>
                                        <a href="http://148.135.136.15/crazyadmin/admin/card-animation-home.php?add=true" rel="noopener noreferrer"><button type="button" id="button-export" class="btn btn-success btn-sm"></i>ADD CARD</button></a>
                                    </td>
                                </tr>
                            </thead>
                        </table>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><a class="btn btn-sm btn-info" href="http://148.135.136.15/crazyadmin/admin/card-animation-home.php?change=true&com=<?= $data['id'] ?>">Change</a></td>
                                                    </tr>
                                                <?php
                                                }
                                                ?>
